...
export const MsgCreatePriceResponse: MessageFns<MsgCreatePriceResponse> = {
  encode(message: MsgCreatePriceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreatePriceResponse>, I>>(object: I): MsgCreatePriceResponse {
    const message = createBaseMsgCreatePriceResponse();
