...
import { QueryParamsResponse } from "./types/perpdex/perpdex/v1/query";
import { QueryShowPriceResponse } from "./types/perpdex/perpdex/v1/query";
import { QueryShowSymbolPriceResponse } from "./types/perpdex/perpdex/v1/query";
import { QueryListPriceResponse } from "./types/perpdex/perpdex/v1/query";

import { QueryParamsRequest } from "./types/perpdex/perpdex/v1/query";
import { QueryShowPriceRequest } from "./types/perpdex/perpdex/v1/query";
import { QueryShowSymbolPriceRequest } from "./types/perpdex/perpdex/v1/query";
import { QueryListPriceRequest } from "./types/perpdex/perpdex/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryShowPrice = (id: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryShowPriceResponse>>>({
   ...
   */
  queryShowSymbolPrice = (symbol: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryShowSymbolPriceResponse>>>({
   ...
   */
  queryListPrice = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryListPriceRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryListPriceResponse>>>({
