...
import { QueryParamsResponse } from "./types/perpdex/loan/v1/query";
import { QueryGetLoanResponse } from "./types/perpdex/loan/v1/query";
import { QueryAllLoanResponse } from "./types/perpdex/loan/v1/query";

import { QueryParamsRequest } from "./types/perpdex/loan/v1/query";
import { QueryGetLoanRequest } from "./types/perpdex/loan/v1/query";
import { QueryAllLoanRequest } from "./types/perpdex/loan/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryParams
   * @request GET:/perpdex/loan/v1/params
   */
  queryParams = (
   ...
   * @tags Query
   * @name queryGetLoan
   * @request GET:/perpdex/loan/v1/loan/{id}
   */
  queryGetLoan = (id: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryGetLoanResponse>>>({
      path: `/perpdex/loan/v1/loan/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryListLoan
   * @request GET:/perpdex/loan/v1/loan
   */
  queryListLoan = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllLoanRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllLoanResponse>>>({
      path: `/perpdex/loan/v1/loan`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
