...
export const MsgRequestLoanResponse: MessageFns<MsgRequestLoanResponse> = {
  encode(_: MsgRequestLoanResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgCancelLoan: MessageFns<MsgCancelLoan> = {
  encode(message: MsgCancelLoan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCancelLoan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgCancelLoanResponse: MessageFns<MsgCancelLoanResponse> = {
  encode(_: MsgCancelLoanResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgCancelLoanResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgApproveLoan: MessageFns<MsgApproveLoan> = {
  encode(message: MsgApproveLoan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgApproveLoan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgApproveLoanResponse: MessageFns<MsgApproveLoanResponse> = {
  encode(_: MsgApproveLoanResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgApproveLoanResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgRepayLoan: MessageFns<MsgRepayLoan> = {
  encode(message: MsgRepayLoan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRepayLoan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgRepayLoanResponse: MessageFns<MsgRepayLoanResponse> = {
  encode(_: MsgRepayLoanResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgRepayLoanResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgLiquidateLoan: MessageFns<MsgLiquidateLoan> = {
  encode(message: MsgLiquidateLoan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgLiquidateLoan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgLiquidateLoanResponse: MessageFns<MsgLiquidateLoanResponse> = {
  encode(_: MsgLiquidateLoanResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgLiquidateLoanResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
