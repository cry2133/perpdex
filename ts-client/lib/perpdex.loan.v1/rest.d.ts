...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryGetLoan: (id: string, query?: Record<string, any>, params?: RequestParams) => Promise<AxiosResponse<{
        loan: {
            id: number;
            amount: string;
            fee: string;
     ...
     */
    queryListLoan: (query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryAllLoanRequest>>>, "">, params?: RequestParams) => Promise<AxiosResponse<{
        loan: {
            id: number;
            amount: string;
            fee: string;
