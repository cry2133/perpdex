...
declare const Client: typeof IgniteClient & import("./helpers").Constructor<{
    ...
    PerpdexLoanV_1: {
        query: ReturnType<typeof import("./perpdex.loan.v1").queryClient>;
        tx: ReturnType<typeof import("./perpdex.loan.v1").txClient>;
        structure: Record<string, unknown>;
        registry: Array<[string, import("@cosmjs/proto-signing").GeneratedType]>;
        updateTX(client: IgniteClient): void;
    };
    ...
    PerpdexPerpdexV_1: {
        query: ReturnType<typeof import("./perpdex.perpdex.v1").queryClient>;
        tx: ReturnType<typeof import("./perpdex.perpdex.v1").txClient>;
        structure: Record<string, unknown>;
        registry: Array<[string, import("@cosmjs/proto-signing").GeneratedType]>;
        updateTX(client: IgniteClient): void;
    };
